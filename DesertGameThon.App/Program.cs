...
namespace DesertGameThon
{
    public class Progrma
    {
        ...
        {
            string url = "https://games-test.datsteam.dev/play/magcarp/player/move";
        ...
        {
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    GameStateResponse gameState = JsonSerializer.Deserialize<GameStateResponse>(jsonResponse, options);
                    return gameState;
                }
                else
                {
                    Console.WriteLine("Error: " + response.StatusCode + response.StatusCode);
                    return null;
                }
            }
        }
